...
namespace MyApplication.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            try
            {
                ...
                foreach (var customerResponse in response)
                {
                    ...
                    customer.SocialSctyNum = customerResponse.SocialScrityNum;
                    customer.Balance = customerResponse.Balance;
                    customer.VipAccount = customerResponse.VipAccount;
        ...
        public async Task<IActionResult> Add(AddVM addVM)
        {
            try
            {
                var response = await CustomerService.Instance.PostAsync<OkResult>(new CreateCustomerRequest(addVM.FirstName, addVM.LastName, addVM.SocialSctyNum, addVM.Balance, addVM.VipAccount, DateTime.Now));
        ...
        public async Task<IActionResult> Edit(int id)
        {
            ...
            Customer customer = new Customer()
            {
                ...
                SocialSctyNum = response.SocialScrityNum,
                Balance = response.Balance,
                VipAccount = response.VipAccount,
        ...
        public async Task<IActionResult> Edit(EditVM vm)
        {
            try
            {
                var response = await CustomerService.Instance.PutAsync<OkResult>(vm.Customer.Id, new UpdateCustomerRequest(vm.Customer.Id, vm.Customer.FirstName, vm.Customer.LastName, vm.Customer.SocialSctyNum, vm.Customer.Balance, vm.Customer.VipAccount, vm.Customer.RegisteredOn));
