...
namespace ProjectApi.Controllers
{
    ...
    public class CustomersController : ControllerBase
    {
        ...
        public IActionResult CreateCustomer(CreateCustomerRequest request)
        {
            try
            {
                var customer = new Customer(request.FirstName, request.LastName, request.SocialSctyNum, request.AccountBalance, request.VipAccount, request.RegisteredOn);
        ...
        public IActionResult UpdateCustomer(int id, UpdateCustomerRequest request)
        {
            try
            {
                ...
                customer.SocialSctyNum = request.SocialScrityNum;
                customer.Balance = request.AccountBalance;
                customer.VipAccount = request.VipAccount;
        ...
        private CustomerResponse GenerateResponse(Customer customer)
        {
            return new CustomerResponse
            {
                ...
                SocialScrityNum = customer.SocialSctyNum,
                Balance = customer.Balance,
                VipAccount = customer.VipAccount,
